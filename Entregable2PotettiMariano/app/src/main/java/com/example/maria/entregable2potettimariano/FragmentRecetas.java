...
public class FragmentRecetas extends Fragment implements AdapterFragment.NotificadorCeldaRecetaClickeadaAdapter {
    ...
    private EditText editTexxtBusqueda;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        armarListaReceta();
        adapterFragment = new AdapterFragment(listaRecetasFragment, this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(adapterFragment);
        editTexxtBusqueda = view.findViewById(R.id.editTextBuesqueda);
        editTexxtBusqueda.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public  void filter(String text){
        ...
        for(Receta RECETA: listaRecetasFragment){
            if(RECETA.getTitulo().toLowerCase().contains(text.toLowerCase())){
                listaFiltrada.add(RECETA);
            }
        }
        adapterFragment.filteredList(listaFiltrada);
